...
if __name__ == "__main__":
    ...
    parser.add_argument('--joint-dir',
                        default='./test_weights/ensemble/HPI_120CSub_OP_T9K9_j0',
                        help='Directory containing "epoch1_test_score.pkl" for joint eval results')
    parser.add_argument('--bone-dir',
                        default='./test_weights/ensemble/HPI_120CSub_OP_T9K9_b0',
                        help='Directory containing "epoch1_test_score.pkl" for bone eval results')
    parser.add_argument('--joint1-dir',
                        default='./test_weights/ensemble/HPI_120CSub_OP_T9K9_j1',
                        help='Directory containing "epoch1_test_score.pkl" for joint eval results')
    parser.add_argument('--bone1-dir',
                        default='./test_weights/ensemble/HPI_120CSub_OP_T9K9_b1',
                        help='Directory containing "epoch1_test_score.pkl" for bone eval results')
    parser.add_argument('--joint2-dir',
                        default='./test_weights/ensemble/HPI_120CSub_OP_T9K9_j2',
                        help='Directory containing "epoch1_test_score.pkl" for joint eval results')
    parser.add_argument('--bone2-dir',
                        default='./test_weights/ensemble/HPI_120CSub_OP_T9K9_b2',
                        help='Directory containing "epoch1_test_score.pkl" for bone eval results')
    ...
    if arg.joint1_dir is not None:
        with open(os.path.join(arg.joint1_dir, 'epoch1_test_score.pkl'), 'rb') as r3:
            r3 = list(pickle.load(r3).items())

    if arg.bone1_dir is not None:
        with open(os.path.join(arg.bone1_dir, 'epoch1_test_score.pkl'), 'rb') as r4:
            r4 = list(pickle.load(r4).items())

    if arg.joint2_dir is not None:
        with open(os.path.join(arg.joint2_dir, 'epoch1_test_score.pkl'), 'rb') as r5:
            r5 = list(pickle.load(r5).items())

    if arg.bone2_dir is not None:
        with open(os.path.join(arg.bone2_dir, 'epoch1_test_score.pkl'), 'rb') as r6:
            r6 = list(pickle.load(r6).items())

    # 2-Stream acc
    alpha = [1.1, 0.9, 0., 0., 0., 0.]
    print('2-Stream acc of HPI_GCN in', arg.dataset)
    eval_cpu(alpha, r1, r2, r3, r4, r5, r6, label)

    # 4-Stream acc
    alpha = [1.1, 0.9, 0.8, 0.8, 0., 0.]
    print('4-Stream acc of HPI_GCN in', arg.dataset)
    eval_cpu(alpha, r1, r2, r3, r4, r5, r6, label)

    # 6-Stream acc
    alpha = [1.1, 0.9, 0.8, 0.8, 0.8, 0.8]
    print('6-Stream acc of HPI_GCN in', arg.dataset)
    eval_cpu(alpha, r1, r2, r3, r4, r5, r6, label)
